...
[![php shield](https://img.shields.io/badge/php-packagist-pink)](https://packagist.org/packages/tradewatch-io/sdk)
...
| [`getHistoricalOhlc(symbol, resolution, start, end)`](https://tradewatch.io/docs/api-reference/currencies/get-historical-ohlc) | symbol, resolution, start, end | Get Historical Ohlc | Get historical OHLC candles for a symbol in a selected resolution and time range. |
| [`getHistoricalTicks(symbol, start, end)`](https://tradewatch.io/docs/api-reference/currencies/get-historical-ticks) | symbol, start, end | Get Historical Ticks | Get raw historical ticks for a symbol in a selected time range using cursor pagination. |
...
| [`getHistoricalOhlc(symbol, resolution, start, end)`](https://tradewatch.io/docs/api-reference/crypto/get-historical-ohlc) | symbol, resolution, start, end | Get Historical Ohlc | Get historical OHLC candles for a symbol in a selected resolution and time range. |
| [`getHistoricalTicks(symbol, start, end)`](https://tradewatch.io/docs/api-reference/crypto/get-historical-ticks) | symbol, start, end | Get Historical Ticks | Get raw historical ticks for a symbol in a selected time range using cursor pagination. |
...
| Method | Required Params | Summary | Description |
| --- | --- | --- | --- |
| [`getHistoricalOhlc(symbol, resolution, start, end)`](https://tradewatch.io/docs/api-reference/indices/get-historical-ohlc) | symbol, resolution, start, end | Get Historical Ohlc | Get historical OHLC candles for a symbol in a selected resolution and time range. |
| [`getHistoricalTicks(symbol, start, end)`](https://tradewatch.io/docs/api-reference/indices/get-historical-ticks) | symbol, start, end | Get Historical Ticks | Get raw historical ticks for a symbol in a selected time range using cursor pagination. |
...
| Method | Required Params | Summary | Description |
| --- | --- | --- | --- |
| [`getHistoricalOhlc(symbol, resolution, start, end)`](https://tradewatch.io/docs/api-reference/commodities/get-historical-ohlc) | symbol, resolution, start, end | Get Historical Ohlc | Get historical OHLC candles for a symbol in a selected resolution and time range. |
| [`getHistoricalTicks(symbol, start, end)`](https://tradewatch.io/docs/api-reference/commodities/get-historical-ticks) | symbol, start, end | Get Historical Ticks | Get raw historical ticks for a symbol in a selected time range using cursor pagination. |
