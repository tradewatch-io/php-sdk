...
class CurrenciesApi
{
     ...
     * @return \OpenAPI\Client\Model\Conversion|\OpenAPI\Client\Model\HTTPValidationError
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Conversion|\OpenAPI\Client\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function convertWithHttpInfo($from, $to, string $contentType = self::contentTypes['convert'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\Conversion' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\Conversion' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\Conversion', []),
            ...
            $returnType = '\OpenAPI\Client\Model\Conversion';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\Conversion',
    ...
    public function convertRequest($from, $to, string $contentType = self::contentTypes['convert'][0])
    {
        ...
        $resourcePath = '/currencies/convert/{from}/{to}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getQuoteRequest($symbol, $precision = 5, string $contentType = self::contentTypes['getQuote'][0])
    {
        ...
        $resourcePath = '/currencies/symbols/{symbol}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getSymbolsRequest($mode, $size = 50, $page = 1, $cursor = null, string $contentType = self::contentTypes['getSymbols'][0])
    {
        ...
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling CurrenciesApi.getSymbols, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/currencies/symbols';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
