...
class StocksApi
{
     ...
     * @return \OpenAPI\Client\Model\CountriesList
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CountriesList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCountriesWithHttpInfo(string $contentType = self::contentTypes['getCountries'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CountriesList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CountriesList' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CountriesList', []),
            ...
            $returnType = '\OpenAPI\Client\Model\CountriesList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CountriesList',
    ...
    public function getQuoteRequest($symbol, $precision = 5, string $contentType = self::contentTypes['getQuote'][0])
    {
        ...
        $resourcePath = '/stocks/symbols/{symbol}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \OpenAPI\Client\Model\Country $country country (optional)
     ...
     */
    public function getSymbols($mode, $size = 50, $country = null, $page = 1, $cursor = null, string $contentType = self::contentTypes['getSymbols'][0])
    {
        list($response) = $this->getSymbolsWithHttpInfo($mode, $size, $country, $page, $cursor, $contentType);
        return $response;
    }
     ...
     * @param  SymbolsListMode $mode Listing mode (required)
     * @param  int $size Page offset (optional, default to 50)
     * @param  \OpenAPI\Client\Model\Country $country (optional)
     * @param  int $page Page number (optional, default to 1)
     * @param  string $cursor Cursor for the next page (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSymbols'] to see the possible values for this operation
     *
     ...
     */
    public function getSymbolsWithHttpInfo($mode, $size = 50, $country = null, $page = 1, $cursor = null, string $contentType = self::contentTypes['getSymbols'][0])
    {
        $request = $this->getSymbolsRequest($mode, $size, $country, $page, $cursor, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSymbolsAsync($mode, $size = 50, $country = null, $page = 1, $cursor = null, string $contentType = self::contentTypes['getSymbols'][0])
    {
        return $this->getSymbolsAsyncWithHttpInfo($mode, $size, $country, $page, $cursor, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSymbolsAsyncWithHttpInfo($mode, $size = 50, $country = null, $page = 1, $cursor = null, string $contentType = self::contentTypes['getSymbols'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CursorPageTCustomizedSymbolsOutFull';
        $request = $this->getSymbolsRequest($mode, $size, $country, $page, $cursor, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSymbolsRequest($mode, $size = 50, $country = null, $page = 1, $cursor = null, string $contentType = self::contentTypes['getSymbols'][0])
    {
        ...
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling StocksApi.getSymbols, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/stocks/symbols';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
