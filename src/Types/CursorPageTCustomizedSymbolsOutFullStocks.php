...
class CursorPageTCustomizedSymbolsOutFullStocks extends JsonSerializableType
{
    /**
     * @var array<SymbolsOutFullStocks> $items
     */
    #[JsonProperty('items'), ArrayType([SymbolsOutFullStocks::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<SymbolsOutFullStocks>,
     *   total?: ?int,
     *   currentPage?: ?string,
