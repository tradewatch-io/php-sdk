...
use Tradewatch\Currencies\Requests\CurrenciesGetHistoricalOhlcRequest;
use Tradewatch\Types\HistoricalOhlcResponse;
use Tradewatch\Currencies\Requests\CurrenciesGetHistoricalTicksRequest;
...
class CurrenciesClient
{
     ...
     *
     * @param string $symbol
     * @param CurrenciesGetHistoricalOhlcRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws TradewatchApiException
     */
    public function getHistoricalOhlc(string $symbol, CurrenciesGetHistoricalOhlcRequest $request, ?array $options = null): HistoricalOhlcResponse
    {
        $options = array_merge($this->options, $options ?? []);
        $query = [];
     ...
     *
     * @param string $symbol
     * @param CurrenciesGetHistoricalTicksRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws TradewatchApiException
     */
    public function getHistoricalTicks(string $symbol, CurrenciesGetHistoricalTicksRequest $request, ?array $options = null): CursorPageTCustomizedHistoricalRawTick
    {
        $options = array_merge($this->options, $options ?? []);
        $query = [];
        $query['start'] = $request->start;
