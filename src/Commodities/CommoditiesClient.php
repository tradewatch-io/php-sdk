...
use Tradewatch\Commodities\Requests\CommoditiesGetHistoricalOhlcRequest;
use Tradewatch\Types\HistoricalOhlcResponse;
use Tradewatch\Commodities\Requests\CommoditiesGetHistoricalTicksRequest;
...
class CommoditiesClient
{
     ...
     *
     * @param string $symbol
     * @param CommoditiesGetHistoricalOhlcRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws TradewatchApiException
     */
    public function getHistoricalOhlc(string $symbol, CommoditiesGetHistoricalOhlcRequest $request, ?array $options = null): HistoricalOhlcResponse
    {
        $options = array_merge($this->options, $options ?? []);
        $query = [];
     ...
     *
     * @param string $symbol
     * @param CommoditiesGetHistoricalTicksRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws TradewatchApiException
     */
    public function getHistoricalTicks(string $symbol, CommoditiesGetHistoricalTicksRequest $request, ?array $options = null): CursorPageTCustomizedHistoricalRawTick
    {
        $options = array_merge($this->options, $options ?? []);
        $query = [];
        $query['start'] = $request->start;
